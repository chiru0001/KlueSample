...
public class TopPics_Adapter extends RecyclerView.Adapter<TopPics_Adapter.Holder> {

    Context context;
    String fragmentName;
    static ArrayList<NewArrivalModel> list;

    public TopPics_Adapter(FragmentActivity activity, ArrayList<NewArrivalModel> new_list, String fragmentName) {

...
public class SubProListAdapter extends RecyclerView.Adapter<SubProListAdapter.Holder> {

    Context context;
    String fragmentName;
    static ArrayList<SubProductListModel> list;

    public SubProListAdapter(FragmentActivity activity, ArrayList<SubProductListModel> new_list, String fragmentName) {
    ...
    public class Holder extends RecyclerView.ViewHolder {
        ...
        TextView pdt_brand, pdt_name, pdt_price, pdt_price_off, price_type, pdt_price_type;
